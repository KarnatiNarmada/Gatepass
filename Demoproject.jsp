...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/const", "root", "Narmada07@");
Statement st=conn.createStatement();

 st = conn.createStatement();
 String sql ="insert into author(aid,name,pin) values(3,'abhi',51550)";
