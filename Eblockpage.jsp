                        ...
                        <article>
                            ...
                            try
                            {
                               Connection con=connections.Establish();
                                ...
                                ResultSet rs=stmt.executeQuery("call EBlockreq('"+strDate+"'");
                            ...
                            %>
                               ...
                               <td><button type="button" class="button1" value="approve" onclick="location.href='ServletApprove1?ID=<%=rs.getString("roll_no")%>'" style="width:60px;
                                     height:20px; 
                                     border:none; 
                                     border-radius:6px; 
                                     font-size:10px; 
                                    ...
                                    <button type="button" class="button2" value="reject" onclick="location.href='ServletReject1?ID=<%=rs.getString("roll_no") %>'" style="width:60px;
                                     height:20px; 
                                     border:none; 
                                     border-radius:6px; 
                                     font-size:10px; 
