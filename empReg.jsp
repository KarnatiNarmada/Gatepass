...
try{
	...
	if(eid!=null){
	stmt.executeUpdate("insert into employee_details(emp_id,first_name,middle_name,last_name,branch,contact_number,role)values('"+eid+"','"+fnm+"','"+mnm+"','"+lnm+"','"+b+"','"+ph+"','"+role+"')");
	stmt.executeUpdate("insert into employee_address(emp_id,house_id,street,pin,mandal,district,state) values('"+eid+"','"+hno+"','"+street+"','"+pin+"','"+mandal+"','"+dist+"','"+state+"')");
	}		
	con.close();
}
