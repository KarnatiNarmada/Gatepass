...
try{
	...
	//String sql1="select*from student_father where emp_id='"+eid+"'";
	//String sql2="select*from student_address where emp_id='"+eid+"'";
      ...
      <form action="#">
        ...
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="rno"value="<%=rs.getString("emp_id")%>">
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="sec"value="<%=rs.getString("role")%>">
          </div>
         <%
	}
	String sql2="select*from student_address where emp_id='"+eid+"'";
	ResultSet rs2=stmt.executeQuery(sql2);
          ...
          String sql1="select*from student_father where roll_no='"+eid+"'";
          ResultSet rs1=stmt.executeQuery(sql1);
          if(rs1.next()){
          %>
          <div class="input-box">
  ...
  <%
   ...
   stmt.executeUpdate("update employee_details set emp_id='"+eid+"',first_name='"+fnm+"',middle_name='"+mnm+"',last_name='"+lnm+"',branch='"+b+"',role='"+role+"',contact_no='"+ph+"',pin='"+pin+"' where emp_id='"+eid+"'");
	stmt.executeUpdate("update employee_address set pin='"+pin+"',mandal='"+mandal+"',district='"+dist+"',state='"+state+"',street='"+street+"',emp_id='"+eid+"',house_no='"+hno+"'where emp_id='"+eid+"'");
