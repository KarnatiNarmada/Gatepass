    ...
    <div class="content">
      <form action="#">
        ...
        <div class="input-box">
            ...
            <input type="text" name="fnm"placeholder="Enter student first name" required>
          </div>
          <div class="input-box">
            <span class="details">Middle Name</span>
            <input type="text" name="mnm"placeholder="Enter student middle name" required>
          </div>
          <div class="input-box">
            <span class="details">Last Name</span>
            <input type="text" name="lnm"placeholder="Enter student last name" required>
          </div>
          <div class="input-box">
            <span class="details">Roll number</span>
            <input type="text" name="rno"placeholder="Enter student roll number" required>
          </div>
          <div class="input-box">
...
try{
	...
	if(rno!=null){
	stmt.executeUpdate("insert into student_details(first_name,middle_name,last_name,roll_no,branch,section,contact_no,pin)values('"+fnm+"','"+mnm+"','"+lnm+"','"+rno+"','"+b+"','"+sec+"','"+ph+"','"+pin+"')");
