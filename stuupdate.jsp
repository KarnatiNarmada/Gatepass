...
try{
  ...
  <%
   ...
   stmt.executeUpdate("update student_details set roll_no='"+rno+"',first_name='"+fnm+"',middle_name='"+mnm+"',last_name='"+lnm+"',branch='"+b+"',section='"+sec+"',contact_no='"+ph+"' where roll_no='"+rno+"'");
